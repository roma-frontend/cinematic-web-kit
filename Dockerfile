...
# Free integrations (all optional; empty by default → feature stays off).
...
ARG NEXT_PUBLIC_CONTACT_DOMAIN=""
ENV NEXT_PUBLIC_CONTACT_DOMAIN=$NEXT_PUBLIC_CONTACT_DOMAIN
RUN npm run build
