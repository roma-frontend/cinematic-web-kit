...
/** Resolve an art base name to its public .webp URL. Served from R2/CDN when
 *  NEXT_PUBLIC_MEDIA_BASE_URL is set, else from the local /public folder. */
export function presetArtUrl(name: string): string {
  return mediaUrl(`${PRESET_ART_BASE}/${name}.webp`);
}
