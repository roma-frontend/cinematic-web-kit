...
const ru: StudioDict = {
  ...
  landingBuilderDesc: 'Полный конструктор лендинга: секции, блоки, тема, hover-эффекты, анимации. Блок «Лендинг-герой» рендерит настоящий кодовый герой — WebGL-фон, браузер-макет, анимированный заголовок. Отредактируйте и жмите «Опубликовать» — главная «/» обновится со всеми эффектами.',
...
const en: StudioDict = {
  ...
  landingBuilderDesc: 'Full landing builder: sections, blocks, theme, hover effects, animations. The “Landing hero” block renders the real coded hero — WebGL background, browser mock, animated headline. Edit and hit “Publish” — the home page “/” updates with all effects.',
...
const hy: StudioDict = {
  ...
  landingBuilderDesc: 'Լենդինգի ամբողջական կոնստրուկտոր՝ բաժիններ, բլոկներ, թեմա, hover-էֆեկտներ, անիմացիաներ։ «Լենդինգ-հերո» բլոկը ցուցադրում է իրական կոդային հերոն՝ WebGL-ֆոն, բրաուզեր-մոկ, անիմացված վերնագիր։ Խմբագրեք և սեղմեք «Հրապարակել» — գլխավոր «/»-ը կթարմացվի բոլոր էֆեկտներով։',
